...
//SendResult的msgId是producer根据指定的算法生成
// 注意SendMessageResponseHeader的msgId是SendResult的offsetMsgId， 这个是broker根据指定的算法生成的
//MessageQueue中有queueId topic brokerName 3个属性
//SendMessageResponseHeader中的queueOffset指的是消息在这个queue中的偏移位置
