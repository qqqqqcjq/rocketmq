...
//RocketMQ使用一个单独的线程PullMessageService来负责消息的拉取。相当于一个服务线程
public class PullMessageService extends ServiceThread {
    ...
    private void pullMessage(final PullRequest pullRequest) {
        ...
        if (consumer != null) {
            //这里将consumer强制转换为DefaultMQPushConsumerImpl，也就是PullMessageService，该线程只为PUSH模式服务，
