...
public class DefaultMQProducer extends ClientConfig implements MQProducer {
     ...
     */
    //默认主题在每一个Broker队列数量 4个写队列  4个读队列
     ...
     */
    //发送消息重试时选择另外一个Broker时，是否不等待存储结果就返回，默认为false。
     ...
     */
    @Override
	   //异步发送消息，回调sendCallback ：onSuccess onException
     ...
     */
    @Override
 //异步发送消息，如果发送超过timeout指定的值，则抛出超时异常。回调sendCallback ：onSuccess onException
     ...
     */
    @Override
    //消息发送，指定消息队列选择算法，覆盖消息生产者默认的消息队列负载均衡算法
