...
public class MessageExt extends Message {
    ...
    private long queueOffset; //记录消息在queue中的偏移位置
    private int sysFlag; //记录一些系统标志，MessageSysFlag中定义了系统标识
    private long bornTimestamp; //消息创建时间，在Producer发送消息时设置
    private SocketAddress bornHost; //记录存储该消息的Broker地址

    private long storeTimestamp;
    private SocketAddress storeHost;
    private String msgId;
    private long commitLogOffset; //记录消息在Broker中存储偏移位置
